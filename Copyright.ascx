<%@ Control Language="c#" AutoEventWireup="True" Codebehind="Copyright.ascx.cs" Inherits="WebMail.Copyright" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
